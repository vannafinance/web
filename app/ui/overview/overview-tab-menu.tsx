...
const Rewards: React.FC = () => (
  <div className="bg-white rounded-3xl border border-purpleBG-lighter p-10 mt-4">
    ...
    <div className="px-4 text-baseBlack">
    ...
    <div className="bg-white mt-6 rounded-lg">
      ...
      <div className="container mx-auto pt-2">
        <div className="flex flex-col md:flex-row">
          ...
          <div className="w-full md:w-2/3">{renderTabContent()}</div>
        </div>
      </div>
    </div>
  );
