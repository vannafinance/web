...
export default function PoolDetailPage({ params }: { params: { id: string } }) {
    ...
    // states for updating input values and usd Prices
    ...
    // Pool Data (e.g., "USDC / USDT")
    const [token0, token1] = useMemo(() => {
        const [symbol0, symbol1] = pool?.name?.split("/")?.map(s => s.trim()) || ["USDC", "USDT"];
    ...
    return (
        ...
        >
            <div className="max-w-screen mx-auto">
                ...
                >
                    {/* Top row: icons, name, badge (centered on mobile, row on md+) */}
                    ...
                    {/* Info row: stacked and centered on mobile, row on md+ */}
                ...
                {/* Main Card - starts immediately after header */}
                <motion.div
